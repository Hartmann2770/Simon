...
- [Victor Kaptelinin](entities/victor-kaptelinin.md) — HCI researcher who applied activity theory to human-computer interaction contexts
- [Yrjö Engeström](entities/yrjo-engestrom.md) — Finnish educational scientist who developed third-generation activity theory and expansive learning
...
- [Context and Consciousness: Activity Theory and Human-Computer Interaction](sources/nardi-1996-context-and-consciousness.md) — Nardi's edited volume introducing activity theory to HCI researchers
- [Developmental Work Research: Expanding Activity Theory in Practice](sources/engestrom-2005-developmental-work-research.md) — Engeström's monograph documenting Change Laboratory interventions as examples of expansive learning
- [Expansive Learning at Work: Toward an Activity Theoretical Reconceptualization](sources/engestrom-2001-expansive-learning-at-work.md) — Engeström's influential journal article reconceptualising learning as expansion of the activity object
- [How Much Do People Forget?](sources/thalheimer-2010.md) — Thalheimer's review of forgetting-curve research and its implications for training design
- [Improving Students' Learning With Effective Learning Techniques](sources/dunlosky-et-al-2013.md) — Dunlosky et al.'s large-scale review rating the efficacy of ten common learning techniques
- [Interleaving Helps Students Distinguish among Similar Concepts](sources/rohrer-2012.md) — Rohrer's review of interleaved practice research showing benefits for discrimination learning
- [Investigating the Testing Effect: Retrieval as a Characteristic of Effective Study Strategies](sources/bae-therriault-redifer-2019.md) — Study examining how retrieval drives the testing effect in student learning contexts
- [Learning as a Generative Process](sources/wittrock-1974.md) — Wittrock's seminal paper introducing generative learning theory
- [Memory and Metamemory Considerations in the Training of Human Beings](sources/bjork-1994.md) — Bjork's chapter introducing the concept of desirable difficulties in learning
- [Metacognition and Cognitive Monitoring: A New Area of Cognitive-Developmental Inquiry](sources/flavell-1979.md) — Flavell's foundational paper coining and defining metacognition
- [Mind in Society: The Development of Higher Psychological Processes](sources/vygotsky-cole-1978-mind-in-society.md) — Vygotsky's foundational text on mediation, the ZPD, and cultural-historical psychology
- [A New Theory of Disuse and an Old Theory of Stimulus Fluctuation](sources/bjork-bjork-1992.md) — Bjork & Bjork's paper distinguishing storage strength from retrieval strength to explain spacing effects
- [Participation, Learning, and Identity: Dialectical Perspectives](sources/roth-et-al-2005-participation-learning-identity.md) — Collection examining learning and identity formation through activity-theory and dialectical lenses
- [Personalized Training Schedules for Retention and Sustainment of CPR Skills](sources/oermann-et-al-2021.md) — Empirical study applying spaced-repetition scheduling to CPR skill retention in nurses
- [Problems of the Development of the Mind](sources/leontev-1981-problems-development-mind.md) — Leont'ev's later work elaborating the psychological basis of activity theory
- [Repeated Retrieval During Learning Is the Key to Long-Term Retention](sources/karpicke-roediger-2007.md) — Karpicke & Roediger experiment demonstrating that repeated retrieval outperforms repeated study
- [Rethinking the Use of Tests: A Meta-Analysis of Practice Testing](sources/sundararajan-adesope-trevisan-2017.md) — Meta-analysis quantifying the benefits of practice testing across educational contexts
- [Retrieval-Based Learning: Research at the Interface between Cognitive Science and Education](sources/nunes-karpicke-2015.md) — Karpicke & Nunes review bridging lab findings on retrieval practice with educational application
- [Ten Benefits of Testing and Their Applications to Educational Practice](sources/roediger-putnam-smith-2011.md) — Roediger et al.'s synthesis of ten distinct ways testing benefits learning and memory
- [Test-Enhanced Learning: Taking Memory Tests Improves Long-Term Retention](sources/roediger-karpicke-2006b.md) — Classic experiment showing that repeated testing outperforms repeated studying for long-term retention
- [Testing Enhances Learning: A Review of the Literature](sources/binks-2018.md) — Nursing-education review of the testing-effect literature and implications for professional training
- [Testing Improves Performance as Well as Assesses Learning](sources/polack-miller-2022.md) — Polack & Miller's review arguing testing improves performance beyond mere assessment
- [The Activity Checklist: A Tool for Representing the 'Space' of Context](sources/kaptelinin-nardi-macaulay-1999-activity-checklist.md) — Kaptelinin et al.'s practical instrument for analysing context of use through activity-theory lenses
- [The Critical Role of Retrieval Practice in Long-Term Retention](sources/roediger-butler-2011.md) — Roediger & Butler's review of retrieval practice research and its educational implications
